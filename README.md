...
Copy the source for the wsat-simple quickstart into this new git repo:
        ...
        cp -r <quickstarts>/kitchensink-angularjs-topcoat/src .
        cp <quickstarts>/kitchensink-angularjs-topcoat/pom.xml .
...
You can now deploy the changes to your OpenShift application using git as follows:
        ...
        git add src pom.xml
        git commit -m "kitchensink-angularjs-topcoat quickstart on OpenShift"
        git push
